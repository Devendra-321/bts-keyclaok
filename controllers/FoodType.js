...
module.exports.createFoodType = function createFoodType(req, res, next) {
  ...
  foodTypeService.createFoodType(req, res, next);
};
 ...
 * @param {function} next - The callback used to pass control to the next action/middleware
 */
 module.exports.bulkCreateFoodType = function bulkCreateFoodType(req, res, next) {
  let foodTypeService = new FoodTypeService(req.Logger);
  foodTypeService.bulkCreateFoodType(req, res, next);
};