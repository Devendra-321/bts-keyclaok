...
module.exports.createAllergy = function createAllergy(req, res, next) {
  ...
  allergyService.createAllergy(req, res, next);
};
...
/**
 * Creates bulk allergy
 *
 * @param {ClientRequest} req - The http request object
 * @param {IncomingMessage} res - The http response object
 * @param {function} next - The callback used to pass control to the next action/middleware
 */
 module.exports.bulkCreateAllergy = function bulkCreateAllergy(req, res, next) {
  let allergyService = new AllergyService(req.Logger);
  allergyService.bulkCreateAllergy(req, res, next);
};